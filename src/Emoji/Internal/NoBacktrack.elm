...
simpleEmoji =
    Parser.oneOf
        ...
        , flagEmoji
        , greatBritainEmoji
        , charInRange ( combineIntoSurrogate 0xD83C 0xDC04, combineIntoSurrogate 0xD83C 0xDFFF ) -- \ud83c[\udc04-\udc04]
        , charInRange ( combineIntoSurrogate 0xD83D 0xDC00, combineIntoSurrogate 0xD83D 0xDFFF ) -- \ud83d[\udc00-\udfff]
        , charInRange ( combineIntoSurrogate 0xD83E 0xDC00, combineIntoSurrogate 0xD83E 0xDFFF ) -- \ud83e[\udc00-\udfff]
        ]
...
greatBritainEmoji =
    Parser.succeed (\simpleCodePoints variationPoints zeroWidthPoints -> simpleCodePoints ++ variationPoints ++ zeroWidthPoints)
        ...
        |= Parser.oneOf
            [ surrogateString [ combineIntoSurrogate 0xDB40 0xDC77, combineIntoSurrogate 0xDB40 0xDC6C, combineIntoSurrogate 0xDB40 0xDC73 ] --\udb40\udc77\udb40\udc6c\udb40\udc73]
            , surrogateString [ combineIntoSurrogate 0xDB40 0xDC73, combineIntoSurrogate 0xDB40 0xDC63, combineIntoSurrogate 0xDB40 0xDC74 ] --\udb40\udc73\udb40\udc63\udb40\udc74]
            , surrogateString [ combineIntoSurrogate 0xDB40 0xDC65, combineIntoSurrogate 0xDB40 0xDC6E, combineIntoSurrogate 0xDB40 0xDC67 ] --\udb40\udc65\udb40\udc6e\udb40\udc67]
            ]
        -- \udb40\udc7f
